...
<div id="first-section" class="first-section mt-lg-2-9 mt-0">
	<div class="container">
		<div class="row g-3">
        	...
        	<div class="col-lg-3 col-12">
        		<div class="browse-cat vertical-is-active">
        			<div class="browse-cat-build">
	                	<button type="button" class="browse-btn"><span><i class="fa fa-list-ul first"></i> <?php esc_html_e('Browse Category', 'storebiz'); ?></span></button>
			...
			<?php } ?>
			<?php if(($hs_slider_content_left =='1') && ($hs_slider_content_right =='1')): ?>
				<div class="col-lg-6 col-12">
			<?php elseif(($hs_slider_content_left =='') && ($hs_slider_content_right =='')): ?>	
							...
							<div class="slider-area">
								<div class="slider-info-content">
									...
									<?php if ( ! empty( $text ) || ! empty( $subtitle ) ) : ?>
										<p> <?php echo esc_html($subtitle); ?>
										<?php echo esc_html($text); ?></p>
									<?php endif; ?>	
									
									<?php if ( ! empty( $button ) ) : ?>
										<a href="<?php echo esc_url($storebiz_slide_info_link); ?>" class="btn btn-white"><?php echo esc_html($button); ?></a>
									<?php endif; ?>	
								</div>
							</div>	
					 	</aside>

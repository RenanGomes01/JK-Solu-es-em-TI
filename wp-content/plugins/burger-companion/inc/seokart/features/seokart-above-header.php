...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';	
	...
	//Pro feature
		class Seokart_social_section_upgrade extends WP_Customize_Control {
			...
			?>
				<a class="customizer_SeoKart_social_upgrade_section up-to-pro" href="https://burgerthemes.com/seokart-pro/" target="_blank" style="display: none;"><?php _e('More Slides Available in SeoKart Pro','seokart'); ?></a>
			<?php
			} 
		}
